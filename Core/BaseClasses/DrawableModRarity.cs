...
namespace BreadLibrary.Core.BaseClasses
{
    ...
    public abstract class DrawableModRarity : ModRarity
    {
        ...
        /// </summary>
        public virtual Color DesiredColor()
        {
            return Color.White;
        }
        ...
        public sealed override Color RarityColor => DesiredColor();
        ...
        {
            Utils.DrawBorderStringFourWay(Main.spriteBatch, GetFont().Value, text, position.X, position.Y, DesiredColor(), BorderColor(), Vector2.Zero, GetScale());
        }
        ...
        private static string CreateVanillaMeasuredText(string visibleText, float desiredWidth)
        {
            ...
            float currentWidth = ChatManager.GetStringSize(
                vanillaFont,
                visibleText,
                Vector2.One
            ).X;
            ...
            float spaceWidth = ChatManager.GetStringSize(
                vanillaFont,
                " ",
                Vector2.One
            ).X;
